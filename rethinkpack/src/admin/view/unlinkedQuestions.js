    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                ...
                // Filter questions that are unlinked
                const unlinkedQuestions = data.filter(question => !question.nextQuestion && question.nextQuestion === '' && !data.some(q => q.nextQuestion === question._id.toString()));


                setQuestions(unlinkedQuestions);
            } catch (error) {
